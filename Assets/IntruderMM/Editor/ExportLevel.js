...
static function PlaySceneInIntruder() 
{
	...
	#endif
	#if UNITY_EDITOR_WIN
	myProc.StartInfo.Arguments = 'loadlevel ' + lastLevelNameNoExtension + '';
	#endif
	myProc.Start();
}
...
static var defaultUploadUrl : String = "https://superbossgames.com/intruder/dlc/upload/";
static var uploadUrl : String = "https://superbossgames.com/intruder/dlc/upload/";
