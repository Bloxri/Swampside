using UnityEditor;
 ...
 public class TagAndLayerImport : AssetPostprocessor 
 {
 	 ...
 	 static string[] tagNames = new string[] { "Enemy", "Door", "Elevator", "Glass", "Slope", "Stairs", "Metal", "", "", "Slippery", "SuperSlippery", "Water", "Dirt", "Carpet", "Movable", "Tire", "ThickMetal", "Deathzone", "MainLevel", "Destructible", "Ladder", "Mover", "" };
